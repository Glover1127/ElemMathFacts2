...
if submit:
    if answer.strip().isdigit():
        ...
        # Only rerun after balloons if not advancing levels
...
if st.session_state.level == 14 and st.session_state.score >= 15:
    ...
    st.balloons()
    time.sleep(2)  # Delay to show final balloons
